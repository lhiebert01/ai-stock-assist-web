# FLAGSHIP ARTICLE — FOR FOUNDER REVIEW

**Status:** DRAFT v1 (written by Claude) — awaiting Lindsay's voice pass
**Destination:** Substack (canonical) → Medium → LinkedIn/Facebook → X
**Length:** ~1,500 words · **Read time:** ~6 minutes

> **How to review:** read it aloud. Anywhere it doesn't sound like you, mark it and
> tell me what you'd say instead — I'll apply the edits. Don't worry about
> formatting; that's mine to fix. Facts have been verified against the live
> product (NVO revenue confirmed at $50.17B on 2026-07-18).
>
> **Screenshot placement** is marked inline as `[SCREENSHOT n]` — those are the
> four images that get embedded when you publish.
...
[SCREENSHOT 1 — NVO card, FX footnote. Caption: "One dated conversion, printed on the card."]
...
[SCREENSHOT 3 — a caveated card. Caption: "Scored on what verified; gaps named; confidence stated."]
...
[SCREENSHOT 5 — framework banner on a printed PDF. Caption: "The methodology travels with the page."]
...
[SCREENSHOT 7 — pre-flight panel. Caption: "Two problems, one panel, zero credits."]
